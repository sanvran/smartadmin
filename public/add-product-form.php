            ...
            if ($product_result == 1) {
                if ($_POST['type'] == 'packet') {
                    ...
                    for ($i = 0; $i < count($_POST['packate_measurement_unit_id']); $i++) {
                        ...
                        $sql = "INSERT INTO product_variant (product_id,type,measurement,measurement_unit_id,price,discounted_price,serve_for,stock,stock_unit_id,images,sku) VALUES('$product_id','$type','$measurement','$measurement_unit_id','$price','$discounted_price','$serve_for','$stock','$stock_unit_id','$variant_other_images','$product_sku')";
                        $db->sql($sql);
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group packate_div">
                                        ...
                                        <input type="number" step="any" min='0' class="form-control" name="packate_price[]" id="packate_price" required />
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group packate_div">
...
<script>
    ...
    $('#add_packate_variation').on('click', function() {
        html = '<div class="row"><hr><div class="col-md-2"><div class="form-group"><label for="measurement">Measurement</label> <i class="text-danger asterik">*</i>' +
    ...
    $('#add_loose_variation').on('click', function() {
        html = '<div class="row"><hr><div class="col-md-4"><div class="form-group"><label for="measurement">Measurement</label> <i class="text-danger asterik">*</i>' +
