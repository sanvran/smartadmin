...
<div class="content-wrapper">
    ...
    <section class="content">
        <h4 id="result"> <?= !empty($message) ? $message : "" ?></h4>
        <div class="row">
            <div class="col-md-12">
                        ...
                        <form id="about_us_form" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control addr_editor" name="about_us" id="about_us" required><?= !empty($res[0]['value']) ? $res[0]['value'] : '' ?></textarea>
                                </div>
                            </div>
