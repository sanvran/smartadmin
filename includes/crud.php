...
define('DOMAIN_URL', 'https://smartjeweller.in/smartadmin/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
define('ALLOW_MODIFICATION', 1);
define('JWT_SECRET_KEY', 'smrtwell_jwt_secret_key'); /* chnage to your secret key here set it to anything you like*/
...
class Database
{
    ...
    private $db_name = "smartadmin";    // Change as required
